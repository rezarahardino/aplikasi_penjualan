			...
			$(document).ready(function(){
				$(".hpsharga").click(function(){
					...
					if (r == true) {
						...
						$.ajax({
							url:'popup/harga/ajax_harga.php?mod=hpsharga',
							type:'POST',
							data: 'id='+id,
						...
						$.ajax({
							url:'popup/harga/ajax_harga.php?mod=listharga',
							type:'GET',
							data:'id=<?php echo $id; ?>',
							success:function(data) {
								$("#dataharga").html(data);
				...
				$('.edtsts').click(function(){
					...
					$.ajax({
						url:'popup/harga/ajax_harga.php?mod=edtstatus',
						type:'POST',
						data: 'id='+id,
						success:function(data) {
							return false;
