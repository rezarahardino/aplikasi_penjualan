...
<?php
	...
	$xml = simplexml_load_file("rpt_pj_perkonsumen.jrxml");
	...
	$PHPJasperXML->arrayParameter=array('tgl' => '"'.$tgl.'"', 'ks' => '"'.$_GET['ks'].'"', 'nama_usaha' => $HEAD['AD_NAMA_USAHA'], 'alamat_usaha' => $HEAD['AD_ALAMAT_USAHA'], 'tgla' => $tgla, 'tgl_cetak' => $tgl_cetak);
