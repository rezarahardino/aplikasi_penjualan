...
<?php
	...
	$xml = simplexml_load_file("rpt_stok.jrxml");
	...
	$PHPJasperXML->arrayParameter=array('nama_usaha' => $HEAD['AD_NAMA_USAHA'], 'alamat_usaha' => $HEAD['AD_ALAMAT_USAHA'],'tgl_cetak' => $tgl_cetak);
