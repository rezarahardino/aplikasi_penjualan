...
<?php
	...
	$xml = simplexml_load_file("rpt_jth_tempo.jrxml");
	...
	$PHPJasperXML->arrayParameter=array('tgl' => '"'.$tgl.'"', 'nama_usaha' => $HEAD['AD_NAMA_USAHA'], 'alamat_usaha' => $HEAD['AD_ALAMAT_USAHA'], 'tgla' => $tgla);
