<?php
	...
	$aksi = 'mod/hutang/act_hutang.php';
		...
		default : 
			...
			echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m12 l12'>
						...
						<form action='med.php?mod=lappjperiode' method='get'>
							<input type='hidden' name='mod' value='hutang'>
		...
		case "view" :
			if (!empty($_GET['pelanggan'])) {
				...
				if ($temukan > 0) {
					...
					<hr>
					<p>
						<a href='med.php?mod=hutang' class='w3-btn w3-red w3-tiny'><i class='fa fa-caret-square-o-left'></i> Kembali</a>

						<a href='med.php?mod=hutang&act=bayar&pelanggan=$_GET[pelanggan]' class='w3-btn w3-blue w3-tiny'><i class='fa fa-file'></i> Bayar Hutang</a>
					</p>
					...
					echo"<script>
						window.location.href = 'med.php?mod=hutang';
					</script>";
				}
					...
					echo"<div class='w3-row-padding'>
						<div class='w3-col s4 w3-card'>
							...
							<div class='w3-card-2 w3-light-green'>
								<form action='$aksi?mod=hutang&act=simpan' method='POST' class='w3-container'>
									...
									<p>
										<a href='med.php?mod=hutang&act=view&pelanggan=$pel[kode_pelanggan]' class='w3-btn w3-orange'><i class='fa fa-caret-square-o-left'></i> Kembali</a> 
									...
									<td>
										<form class='w3-tiny' action='' method='GET'>	
											...
											<div class='w3-row'>
												...
												<div class='w3-col s1'>
													<a href='med.php?mod=hutang&act=bayar&pelanggan=$pel[kode_pelanggan]' class='w3-btn w3-dark-grey w3-tiny'><i class='fa fa-refresh'></i> REFRESH</a>
												</div>
											</div>
										</form>
									</td>
								...
								if($fd_kul > 0)
								{
									...
									while ($m = mysql_fetch_assoc($sql_kul)) {
										echo"<tr>
											...
											<td>".nama_petugas($m['petugas'])."</td>
											<td><a href='$aksi?mod=hutang&act=hapus&id=$m[id_bayar]' onclick=\"return confirm('Yakin hapus data');\"><i class='fa fa-trash w3-large w3-text-red'></i></a>
											</td>
										</tr>";
										$no++;
									}
