		...
		default :
			...
			echo"<table style='margin-top:12px;'>
				<tr>
					...
					<a href='med.php?mod=barang&act=form' class='w3-btn w3-small w3-blue'><i class='fa fa-file'></i> Tambah</a>

					<a href='popup/popup.php?mod=cetakbarang' class='w3-btn w3-small w3-teal' target='_blank'><i class='fa fa-print'></i> Cetak</a></td>
				</tr>
				...
				if($fd_kul > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kul)) {
						echo"<tr>
							...
							<a href='med.php?mod=barang&act=form&id=$m[kode_barang]'><i class='fa fa-pencil-square w3-large w3-text-blue'></i></a> 
							<a href='$aksi?mod=barang&act=hapus&id=$m[kode_barang]' onclick=\"return confirm('Yakin ingin menghapus data?');\"><i class='fa fa-trash w3-large w3-text-red'></i></a></td>
