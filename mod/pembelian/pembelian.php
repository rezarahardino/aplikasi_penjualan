		...
		case "detail" :
			...
			if(isset($_GET['id']))
			{
				...
				echo"<tr class='w3-light-grey'>
					...
					<tr class='w3-light-grey'>
						<td colspan='5'><center>
						<a href='#' class='w3-text-blue' onclick=\"document.getElementById('id01').style.display='block'\">Edit Detail</a></center>
						</td>
					</tr>
					</tbody>
				</table>
			...
			<div id="id01" class="w3-modal">
			  <div class="w3-modal-content">
			    <div class="w3-container">
			      ...
			      <h3>Edit Qty</h3>
			      <form action="<?php echo $aksi; ?>?mod=pembelian&act=editqty" method="POST">
			      <input type='hidden' name='no_faktur' id='no_faktur' value='<?php echo $tra['no_faktur']; ?>'>
			      <?php
			      echo"<table class='w3-table w3-tiny w3-hoverable tbl'>
						...
						$sql_tmp = mysql_query("SELECT a.kode_barang, a.qty, a.harga_beli, b.nama_barang 
												FROM tb_detail_pembelian a, tb_barang b
												WHERE a.kode_barang = b.kode_barang 
												AND a.no_faktur = '$tra[no_faktur]'") or die(mysql_error());
						$no = 1;
						...
						if(mysql_num_rows($sql_tmp) > 0)
						{
							...
							while ($b = mysql_fetch_assoc($sql_tmp)) {
								...
								<tr style='border-bottom:1px dashed #ccc;'>
									...
									$no</td>
									<td>$b[nama_barang]</td>
									<td width='150px'><input type='text' class='w3-input w3-border w3-tiny' name='harga_beli_".$i."' value='".$b['harga_beli']."'></td>
