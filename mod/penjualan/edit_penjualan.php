		...
		case "printout" :
			...
			if(isset($_GET['id']))
			{
				...
				<p>
				    ...
				    <a href='mod=penjualan&act=editqty' class='w3-btn w3-dark-gren w3-tiny' ><i class='fa fa-pencil-square'></i> Edit</a>
				...
				if($fd_kul > 0)
				{
					...
					while ($m = mysql_fetch_assoc($sql_kul)) {
						...
						echo"<tr>
							...
							<a href='$aksi?mod=penjualan&act=editqty' class='w3-text-blue' onclick=\"document.getElementById('id01').style.display='block'\">Edit Transaksi</a>
