<?php
	...
	//link buat paging
	$linkaksi = 'med.php?mod=returpembelian';
	...
	$aksi = 'mod/retur/act_retur_pembelian.php';
			...
			echo"<div class='w3-row-padding'>
				<div class='w3-col s3 w3-card'>
					...
					<div class='w3-card-2 w3-grey'>
						<form action='$aksi?mod=returpembelian&act=simpan' method='POST' class='w3-container'>
						...
						<tr>
							<td>
								<form class='w3-tiny' action='' method='GET'>	
									<input type='hidden' name='mod' value='returpembelian'>
									<div class='w3-row'>
										<div class='w3-col s1'>
										...
										<div class='w3-col s1'>
											<a href='med.php?mod=returpembelian' class='w3-btn w3-dark-grey w3-tiny'><i class='fa fa-refresh'></i> REFRESH</a>
										</div>
									</div>
								</form>
							</td>
						...
						if($fd_kul > 0)
						{
							...
							while ($m = mysql_fetch_assoc($sql_kul)) {
								...
								echo"<tr>
									<td>$no</td>
									<td>$m[nomor_retur]</td>
									<td><a class='w3-hover-text-red w3-text-blue' href='med.php?mod=pembelian&act=detail&id=$m[no_faktur]'>$m[no_faktur]</a></td>
									<td>$m[kode_barang]</td>
									<td>$m[nama_barang]</td>
									<td>Rp. ".number_format($m['harga_beli'])." X $m[qty]</td>
									<td>Rp. ".number_format($total_harga)."</td>
									<td><a href='$aksi?mod=returpembelian&act=hapus&id=$m[no_faktur]&kode=$m[kode_barang]' onclick=\"return confirm('Yakin hapus data');\"><i class='fa fa-trash w3-large w3-text-red'></i></a>
									</td>
								</tr>";
								$no++;
							}
