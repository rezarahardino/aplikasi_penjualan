<?php
	...
	//link buat paging
	$linkaksi = 'med.php?mod=returpenjualan';
	...
	$aksi = 'mod/retur/act_retur_penjualan.php';
			...
			echo"<div class='w3-row-padding'>
				<div class='w3-col s3 w3-card'>
					...
					<div class='w3-card-2 w3-light-blue'>
						<form action='$aksi?mod=returpenjualan&act=simpan' method='POST' class='w3-container'>
						...
						<tr>
							<td>
								<form class='w3-tiny' action='' method='GET'>	
									<input type='hidden' name='mod' value='returpenjualan'>
									<div class='w3-row'>
										<div class='w3-col s1'>
										...
										<div class='w3-col s1'>
											<a href='med.php?mod=returpenjualan' class='w3-btn w3-dark-grey w3-tiny'><i class='fa fa-refresh'></i> REFRESH</a>
										</div>
									</div>
								</form>
							</td>
						...
						if($fd_kul > 0)
						{
							...
							while ($m = mysql_fetch_assoc($sql_kul)) {
								...
								echo"<tr>
									<td>$no</td>
									<td>$m[nomor_retur]</td>
									<td><a class='w3-hover-text-red w3-text-blue' href='med.php?mod=penjualan&act=printout&id=$m[no_transaksi]'>$m[no_transaksi]</a></td>
									<td>$m[kode_barang]</td>
									<td>$m[nama_barang]</td>
