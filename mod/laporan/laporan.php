		...
		case 'stokbarang':
			...
			<div class='w3-row'>
				<div class='w3-col s12'>
					<a href='popup/popup.php?mod=cetakstok&act=html' target='_blank' class='w3-btn' name='submit' value='Cetak'>Cetak</a>

					<a href='popup/cetak_stok_pdf.php' target='_blank' class='w3-btn w3-red' name='submit' value='Cetak'>Cetak PDF</a>
				</div>
			</div>";
		...
		case 'laris':
			...
			echo"<table style='margin-top:12px;'>
				<tr>
					...
					<td align='right'><a href='med.php?mod=laporan&act=laris' class='w3-btn w3-dark-grey w3-small'><i class='fa fa-refresh'></i> Refresh</a>
					</td>
				</tr>
			...
			case 'penjualan':
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php' method='get' target='_blank'>
							<input type='hidden' name='mod' value='lappjperiode'>
							<table>
								<tr>
									<td>Tanggal Dari :</td>
								...
								<tr>
									<td>Jenis Cetak :</td>
									<td>
										<input type='radio' class='w3-radio' name='act' value='html'>
										<label class='w3-validate'>HTML</label>

										<input type='radio' class='w3-radio' name='act' value='pdf'>
					...
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-grey'>
							<h4>Rekap Penjualan Konsumen Per-Hari </h4>
						</div>

						<form action='popup/popup.php' method='get' target='_blank'>
							<input type='hidden' name='mod' value='pjperkonsumen'>
							<table>
								<tr>
									<td>Tanggal :</td>
									<td><select name='ks' class='w3-select w3-small' required>
											<option value=''>- Pilih Pelanggan -</option>";

											$rsqlks = mysql_query("SELECT * FROM tb_pelanggan");
											while($ks = mysql_fetch_assoc($rsqlks)) {
												echo"<option value='$ks[kode_pelanggan]'>$ks[nama_pelanggan]</option>";
											}
			...
			case 'pembelian':
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php' method='GET' target='_blank'>
							<input type='hidden' name='mod' value='lapblperiode'>
							<table>
								<tr>
									<td>Tanggal Dari :</td>
									<td><input type='text' name='tgl1' id='tgl1' class='w3-input w3-small' placeholder='yyyy-mm-dd' readonly></td>
					...
					<div class='w3-col s12 m6 l6'>
						<div class='w3-container w3-grey'>
							<h4>Rekap Pembelian Per-Supplier </h4>
						</div>

						<form action='popup/popup.php' method='get' target='_blank'>
							<input type='hidden' name='mod' value='blpersupplier'>
							<table>
								<tr>
									<td>Tanggal :</td>
									<td><select name='sp' class='w3-select w3-small' required>
											<option value=''>- Pilih Supplier -</option>";

											$rsqlks = mysql_query("SELECT * FROM tb_supplier");
											while($ks = mysql_fetch_assoc($rsqlks)) {
												echo"<option value='$ks[kode_supplier]'>$ks[nama_toko]</option>";
											}
			...
			case 'barang':
				...
				echo"<div class='w3-row-padding'>
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php' method='GET' target='_blank'>
							<input type='hidden' name='mod' value='laplarisbrgbln'>
							<table>
								<tr>
									<td>Pilih Bulan :</td>
					...
					<div class='w3-col s12 m6 l6'>
						...
						<form action='popup/popup.php' method='get' target='_blank'>
							<input type='hidden' name='mod' value='lapjthtempo'>
							<table>
								<tr>
									<td>Tanggal :</td>
									<td><input type='text' name='tgl' class='w3-input w3-small dp' placeholder='yyyy-mm-dd' readonly></td>
